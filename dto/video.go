...
type VideoRequest struct {
	...
	InputReference []string       `json:"input_reference,omitempty"`                                                                                                                                             // Standard reference-image array for Gemini/Omni style video APIs
	Resolution     string         `json:"resolution,omitempty" example:"720p"`                                                                                                                                   // Standard resolution field
	AspectRatio    string         `json:"aspect_ratio,omitempty" example:"16:9"`                                                                                                                                 // Standard aspect ratio field
	FirstLastFrame bool           `json:"first_last_frame,omitempty"`                                                                                                                                            // Start/end frame mode for fast video models
