...
type ChannelOtherSettings struct {
	...
	DynamicModelMapping                   []DynamicModelMappingRule `json:"dynamic_model_mapping,omitempty"`
	AdvancedCustom                        *AdvancedCustomConfig     `json:"advanced_custom,omitempty"`
}

type DynamicModelMappingRule struct {
	From            string                         `json:"from,omitempty"`
	To              string                         `json:"to,omitempty"`
	When            []DynamicModelMappingCondition `json:"when,omitempty"`
	FieldTransforms []DynamicFieldTransform        `json:"field_transforms,omitempty"`
}

type DynamicModelMappingCondition struct {
