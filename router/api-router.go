...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.POST("/web3-pay/webhook", anonymousRequestBodyLimit, controller.Web3PayWebhook)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/web3-pay/amount", controller.RequestWeb3PayAmount)
				selfRoute.POST("/web3-pay/pay", middleware.CriticalRateLimit(), controller.RequestWeb3Pay)
				selfRoute.GET("/web3-pay/order/:trade_no", controller.GetWeb3PayOrderStatus)
		...
		performanceRoute.Use(middleware.RootAuth())
		{
			...
			performanceRoute.GET("/logs/search", controller.SearchServerLogs)
