...
>(function ModelRatioVisualEditor(
  ...
  const models = useMemo(() => {
    const savedRows = buildModelSnapshots({
      ...
      perRequestRules: savedPerRequestRules,
    })
  ...
  const handleEdit = useCallback(
    (model: ModelRow) => {
      ...
      setEditData({
        ...
        perRequestRule: editableModel.perRequestRule,
      })
      setEditorOpen(true)
  ...
  const handleDelete = useCallback(
    (name: string) => {
      ...
      const perRequestRuleMap =
        parsePerRequestRules(perRequestRules) as PerRequestRules
...
export const ModelRatioVisualEditor = memo(
  ...
  (prevProps, nextProps) => {
    return (
      ...
      prevProps.savedPerRequestRules === nextProps.savedPerRequestRules &&
