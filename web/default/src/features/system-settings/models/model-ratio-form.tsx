...
const modelJsonFields: Array<{
  ...
  {
    name: 'PerRequestRules',
    labelKey: 'Resolution pricing',
    descriptionKey:
      'JSON map of model → per-request image or video resolution pricing rules.',
  },
]
        ...
        {editMode === 'visual' ? (
          <div className='space-y-6'>
            <ModelRatioVisualEditor
              ...
              savedPerRequestRules={savedValues.PerRequestRules}
              ...
              perRequestRules={form.watch('PerRequestRules')}
              candidateModelNames={
              ...
              onChange={(field, value) => {
                const fieldMap: Record<string, keyof ModelFormValues> = {
                  ...
                  'per_request_pricing.rules': 'PerRequestRules',
                }
                const formField =
